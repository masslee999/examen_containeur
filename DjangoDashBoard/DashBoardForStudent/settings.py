"""
Django settings for DashBoardForStudent project.
...
ROOT_URLCONF = 'DashBoardForStudent.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'StudentList'/ 'templates' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'DashBoardForStudent.wsgi.application'
...
STATICFILES_DIRS = [BASE_DIR / 'StudentList'/ 'static']
